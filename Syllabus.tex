...
\begin{description}
%	\ii[\isRp\ Required, unlimited]
%	Topics in this category are prerequisite knowledge
%	and can be used without definition in problem statements.
%	However, the terms in this topic will not appear
%	in a problem statement itself without definition.
	...
	gives a substantial advantage are rare.
	They may still be applicable in some situations;
	however the intended solution will seldom invoke such topics.
\end{description}
